    ...
    <div className="front1">
      ...
      <nav className={`front3 ${isVisible ? 'visible' : 'hidden'}`}>
        <div className="front4">
          ...
          <div className="front7" style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
            <a href="#features" style={{ textDecoration: 'none', color: 'inherit', padding: '4px 8px' }}>Features</a>
            <a href="#about" style={{ textDecoration: 'none', color: 'inherit', padding: '4px 8px' }}>About</a>
            <a href="#contact" style={{ textDecoration: 'none', color: 'inherit', padding: '4px 8px' }}>Contact</a>
            {/* Admin Login Dropdown styled as nav link */}
            <div
              className="dropdown"
              style={{
                position: 'relative',
